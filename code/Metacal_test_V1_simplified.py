...
def make_sim_one_cutout(noise_rng, dither_rng, g1, g2, mag, open_meds, obj_ind, cutout):
    m = open_meds
    ...
    im = obj.drawImage(nx=dim, ny=dim,  wcs=wcs,
                       ...
                       offset = galsim.PositionD(x=dither[0],  y=dither[1])).array * mag_to_flux(mag) #multiplying by flux here, is that what I really want?
